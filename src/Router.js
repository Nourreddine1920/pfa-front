...
const routes = [
  ...
  { path: "students", component: StudentsList, exact: true },
  { path: "add-student", component: AddStudent, exact: true },
  { path: "edit-student", component: EditStudent, exact: true },
  { path: "student-details", component: StudentDetails, exact: true },
  { path: "teachers", component: TeachersList, exact: true },
  { path: "add-teacher", component: AddTeacher, exact: true },
  { path: "edit-teacher", component: EditTeacher, exact: true },
  { path: "teacher-details", component: TeacherDetails, exact: true },
