        ...
        <Row>
          <Col lg={3} md={4}>
            ...
            <ul className="inbox-menu">
              <li className="active">
                <a href="#">
                  <FontAwesomeIcon icon={faDownload} /> Inbox
              ...
              <li>
                <a href="#">
                  <FontAwesomeIcon icon={faPaperPlane} /> Sent Mail
                </a>
              </li>
              <li>
                <a href="#">
                  <FontAwesomeIcon icon={faFileAlt} /> Drafts
                    ...
                    <div className="col-auto top-action-right">
                      <div className="text-end">
                        <button
                          ...
                          className="btn btn-white d-none d-md-inline-block me-2"
                        >
                    ...
                    <table className="table table-inbox table-hover">
                      ...
                      <tbody>
                        ...
                        <tr className="unread clickable-row">
                          ...
                          <td> </td> <td className="mail-date"> 8: 42 </td>
                        </tr>
                        <tr className="clickable-row">
                          ...
                          <td> </td> <td className="mail-date"> 30 Nov </td>
                        </tr>
                        <tr className="unread clickable-row">
                          <td>
                            <input type="checkbox" className="checkmail" />
                          ...
                          <td> </td> <td className="mail-date"> 18 Sep </td>
                        </tr>
                        <tr className="clickable-row">
                          <td>
                            <input type="checkbox" className="checkmail" />
                          ...
                          <td> </td> <td className="mail-date"> 21 Aug </td>
                        </tr>
                        <tr className="clickable-row">
                          <td>
                            <input type="checkbox" className="checkmail" />
                          ...
                          <td> </td> <td className="mail-date"> 1 Aug </td>
                        </tr>
                        <tr className="unread clickable-row">
                          <td>
                            <input type="checkbox" className="checkmail" />
                          ...
                          <td> </td> <td className="mail-date"> Jul 13 </td>
                        </tr>
                        <tr className="clickable-row">
                          <td>
                            <input type="checkbox" className="checkmail" />
