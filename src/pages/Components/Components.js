...
import {
  ...
  Breadcrumb,
  Button,
  ButtonGroup, Card, Col, Dropdown,
  DropdownButton, ListGroup,
  Nav, Pagination,
  ProgressBar, Row, Tab, Tabs
        ...
        <section className="comp-section">
          ...
          <Card>
            <Card.Body>
              ...
              <Button variant="link"> Link </Button> <hr />
              ...
              <Button variant="warning" size="lg" className="me-1">
                Warning
              </Button>
              ...
              <Button variant="dark" size="lg" className="me-1">
                Dark
              </Button>
              ...
              <Button variant="dark" size="sm" className="me-1">
                Dark
              </Button>
          ...
          <Card>
            <Card.Header>
              ...
              <Card.Text>
                use <code> .btn - rounded </code> in className to get Rounded
                button
              </Card.Text>
            </Card.Header>
            <Card.Body>
              <Button variant="primary" className="me-1 btn-rounded">
                Primary
              </Button>
              <Button variant="secondary" className="me-1 btn-rounded">
                Secondary
              </Button>
              <Button variant="success" className="me-1 btn-rounded">
                Success
              </Button>
              <Button variant="warning" className="me-1 btn-rounded">
                Warning
              </Button>
              <Button variant="danger" className="me-1 btn-rounded">
                Danger
              </Button>
              <Button variant="info" className="me-1 btn-rounded">
                Info
              </Button>
              <Button variant="light" className="me-1 btn-rounded">
                Light
              </Button>
              <Button variant="dark" className="me-1 btn-rounded">
                Dark
              </Button>
              ...
              <p>
                ...
                <code>outline-*</code> variant to get Rounded Outline button
              </p>
              <Button variant="outline-primary" className="me-1 btn-rounded">
                Primary
              </Button>
              <Button variant="outline-secondary" className="me-1 btn-rounded">
                Secondary
              </Button>
              <Button variant="outline-success" className="me-1 btn-rounded">
                Success
              </Button>
              <Button variant="outline-warning" className="me-1 btn-rounded">
                Warning
              </Button>
              <Button variant="outline-danger" className="me-1 btn-rounded">
                Danger
              </Button>
              <Button variant="outline-info" className="me-1 btn-rounded">
                Info
              </Button>
              <Button variant="outline-light" className="me-1 btn-rounded">
                Light
              </Button>
              <Button variant="outline-dark" className="btn-rounded">
                Dark
              </Button>
            </Card.Body>
          </Card>
          ...
          <Card>
            <Card.Header>
              ...
              <Card.Text>
                Use <code> outline - * </code> varient for outline buttons.
              </Card.Text>
            </Card.Header>
            <Card.Body>
        ...
        <section className="comp-section">
          ...
          <Row>
            <div className="col-12 col-md-6 col-lg-4 d-flex">
              <Card>
                <Card.Img variant="top" src={"assets/img/img-01.jpg"} />
                <Card.Header>
            ...
            <div className="col-12 col-md-6 col-lg-4 d-flex">
              <Card>
                ...
                <Card.Footer>This is my header </Card.Footer>
              </Card>
            </div>
            <div className="col-12 col-md-6 col-lg-4 d-flex">
              <Card>
        ...
        <section className="comp-section comp-dropdowns">
          ...
          <Card>
            <Card.Body>
              ...
              <DropdownButton as={ButtonGroup} variant="danger" title="Action">
                <Dropdown.Item eventKey="1"> Action </Dropdown.Item>
                <Dropdown.Item eventKey="2"> Another action </Dropdown.Item>
                <Dropdown.Item eventKey="3" active>
                  Active Item
